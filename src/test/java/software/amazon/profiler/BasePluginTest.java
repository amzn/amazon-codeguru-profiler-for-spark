...
public class BasePluginTest {
    ...
    public void testGetContextWithFirstSparkConfDefinedInExecutor() throws Exception {
        ...
        conf.set("spark.executorEnv.ENABLE_AMAZON_PROFILER", "true");
        ProfilingContext context = new BasePlugin().getContext(conf, false);
        Assertions.assertNull(context);
    }
    ...
    public void testGetContextWithBothSparkConfDefinedInExecutor() throws Exception {
        SparkConf conf = new SparkConf();
        conf.set("spark.executorEnv.ENABLE_AMAZON_PROFILER", "true");
        conf.set("spark.executorEnv.PROFILING_CONTEXT", "{\"profilingGroupName\":\"Sample-Spark-App-Beta\"}");
    ...
    public void testGetContextWithAllFlagsEnabledInSparkConfForExecutor() throws Exception {
        SparkConf conf = new SparkConf();
        conf.set("spark.executorEnv.ENABLE_AMAZON_PROFILER", "true");
        conf.set("spark.executorEnv.PROFILING_CONTEXT", "{\"profilingGroupName\":\"Sample-Spark-App-Beta\",\"driverEnabled\":\"true\"}");
    ...
    public void testGetContextWithAllFlagsDisabledInSparkConfForExecutor() throws Exception {
        SparkConf conf = new SparkConf();
        conf.set("spark.executorEnv.ENABLE_AMAZON_PROFILER", "true");
        conf.set("spark.executorEnv.PROFILING_CONTEXT", "{\"profilingGroupName\":\"Sample-Spark-App-Gamma\",\"executorEnabled\":\"false\",\"heapSummaryEnabled\":\"false\"}");
    ...
    public void testGetContextWithFirstSparkConfDefinedInDriver() throws Exception {
        SparkConf conf = new SparkConf();
        conf.set("spark.yarn.appMasterEnv.ENABLE_AMAZON_PROFILER", "true");
        ProfilingContext context = new BasePlugin().getContext(conf, true);
        Assertions.assertNull(context);
    }
    ...
    public void testGetContextWithBothSparkConfDefinedInDriver() throws Exception {
        SparkConf conf = new SparkConf();
        conf.set("spark.yarn.appMasterEnv.ENABLE_AMAZON_PROFILER", "true");
        conf.set("spark.yarn.appMasterEnv.PROFILING_CONTEXT", "{\"profilingGroupName\":\"Sample-Spark-App-Beta\"}");
    ...
    public void testGetContextWithAllFlagsEnabledInSparkConfForDriver() throws Exception {
        SparkConf conf = new SparkConf();
        conf.set("spark.yarn.appMasterEnv.ENABLE_AMAZON_PROFILER", "true");
        conf.set("spark.yarn.appMasterEnv.PROFILING_CONTEXT", "{\"profilingGroupName\":\"Sample-Spark-App-Beta\",\"driverEnabled\":\"true\"}");
    ...
    public void testGetContextWithAllFlagsDisabledInSparkConfForDriver() throws Exception {
        SparkConf conf = new SparkConf();
        conf.set("spark.yarn.appMasterEnv.ENABLE_AMAZON_PROFILER", "true");
        conf.set("spark.yarn.appMasterEnv.PROFILING_CONTEXT", "{\"profilingGroupName\":\"Sample-Spark-App-Gamma\",\"executorEnabled\":\"false\",\"heapSummaryEnabled\":\"false\"}");
